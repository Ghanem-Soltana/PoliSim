			...
			if(elment instanceof EReference)
			{
				...
				for (int i = 0; i < dep.size(); i++) {
					...
					if(targetNode!=null)
					{
								...
								{System.err.println("(REF: "+ref+") There is a cyclic dependency between "+sourceName+ " and " + targetName);
								System.exit(0);}
			...
			if(elment instanceof EAttribute)
			{
				...
				for (int i = 0; i < dep.size(); i++) {
					...
					if(targetNode!=null)
					{
								...
								{System.err.println("(ATT: "+att.getName()+" | "+att.getEContainingClass()+") There is a cyclic dependency between "+sourceName+ " and " + target);
								System.exit(0);}
